...
#
# Generated by export_simulation on Tue Oct 22 00:41:33 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './diviseur_5b_par4.sh' script.

./diviseur_5b_par4.sh -reset_run
...
./diviseur_5b_par4.sh -noclean_files

For more information on the script, please type './diviseur_5b_par4.sh -help'.
