...
#
# Generated by export_simulation on Tue Oct 22 05:36:44 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './mini_UAL.sh' script.

./mini_UAL.sh -reset_run
...
./mini_UAL.sh -noclean_files

For more information on the script, please type './mini_UAL.sh -help'.
