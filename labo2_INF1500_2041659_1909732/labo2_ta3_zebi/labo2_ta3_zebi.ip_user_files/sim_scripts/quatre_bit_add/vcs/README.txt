...
#
# Generated by export_simulation on Tue Oct 22 00:11:36 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './quatre_bit_add.sh' script.

./quatre_bit_add.sh -reset_run
...
./quatre_bit_add.sh -noclean_files

For more information on the script, please type './quatre_bit_add.sh -help'.
