...
################################################################
# This is a generated script based on design: comparateur_1bit
#
...
# source comparateur_1bit_script.tcl
...
set design_name comparateur_1bit
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net a_1 [get_bd_ports a] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_nor2_0/a]
  connect_bd_net -net b_1 [get_bd_ports b] [get_bd_pins xup_and2_0/b] [get_bd_pins xup_nor2_0/b]
  connect_bd_net -net xup_and2_0_y [get_bd_pins xup_and2_0/y] [get_bd_pins xup_or2_0/a]
  connect_bd_net -net xup_nor2_0_y [get_bd_pins xup_nor2_0/y] [get_bd_pins xup_or2_0/b]
  connect_bd_net -net xup_or2_0_y [get_bd_ports cout] [get_bd_pins xup_or2_0/y]
