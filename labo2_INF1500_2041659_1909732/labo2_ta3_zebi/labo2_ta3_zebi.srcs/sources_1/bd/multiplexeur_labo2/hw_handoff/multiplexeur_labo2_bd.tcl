...
################################################################
# This is a generated script based on design: multiplexeur_labo2
#
...
# source multiplexeur_labo2_script.tcl
...
set design_name multiplexeur_labo2
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net d0_1 [get_bd_ports d0] [get_bd_pins xup_and3_0/c] [get_bd_pins xup_and3_1/c]
  connect_bd_net -net d1_1 [get_bd_ports d1] [get_bd_pins xup_and3_2/c]
  connect_bd_net -net d2_1 [get_bd_ports d2] [get_bd_pins xup_and3_3/c]
  connect_bd_net -net r0_1 [get_bd_ports r0] [get_bd_pins xup_and3_1/a] [get_bd_pins xup_and3_3/a] [get_bd_pins xup_inv_0/a]
  connect_bd_net -net r1_1 [get_bd_ports r1] [get_bd_pins xup_and3_2/a] [get_bd_pins xup_and3_3/b] [get_bd_pins xup_inv_1/a]
  connect_bd_net -net xup_and3_0_y [get_bd_pins xup_and3_0/y] [get_bd_pins xup_or4_0/a]
  connect_bd_net -net xup_and3_1_y [get_bd_pins xup_and3_1/y] [get_bd_pins xup_or4_0/b]
  connect_bd_net -net xup_and3_2_y [get_bd_pins xup_and3_2/y] [get_bd_pins xup_or4_0/c]
  connect_bd_net -net xup_and3_3_y [get_bd_pins xup_and3_3/y] [get_bd_pins xup_or4_0/d]
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and3_0/a] [get_bd_pins xup_and3_2/b] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_inv_1_y [get_bd_pins xup_and3_0/b] [get_bd_pins xup_and3_1/b] [get_bd_pins xup_inv_1/y]
  connect_bd_net -net xup_or4_0_y [get_bd_ports cout] [get_bd_pins xup_or4_0/y]
