...
################################################################
# This is a generated script based on design: muxxxxx
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set K [ create_bd_port -dir I K ]
  set P [ create_bd_port -dir I P ]
  set S01 [ create_bd_port -dir I S01 ]
  set SORTIE [ create_bd_port -dir O SORTIE ]
  ...
  connect_bd_net -net K_1 [get_bd_ports K] [get_bd_pins xup_and2_1/b]
  connect_bd_net -net P_1 [get_bd_ports P] [get_bd_pins xup_and2_0/b]
  connect_bd_net -net S01_1 [get_bd_ports S01] [get_bd_pins xup_and2_0/a] [get_bd_pins xup_inv_0/a]
  ...
  connect_bd_net -net xup_inv_0_y [get_bd_pins xup_and2_1/a] [get_bd_pins xup_inv_0/y]
  connect_bd_net -net xup_or2_0_y [get_bd_ports SORTIE] [get_bd_pins xup_or2_0/y]
