...
#
# Generated by export_simulation on Mon Nov 04 22:03:18 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './MUX_4_BITOO.sh' script.

./MUX_4_BITOO.sh -reset_run
...
./MUX_4_BITOO.sh -noclean_files

For more information on the script, please type './MUX_4_BITOO.sh -help'.
